    ...
    <div class="main-sidemenu">
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{ 'Hi ' . Auth::user()->name }}</h4>
        ...
        <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('invoice/paid_invoice') }}">الفواتير المدفوعة</a>

                            </li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('invoice/unpaid_invoice') }}">الفواتير
                                    الغيرمدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('invoice/invoices_Partial') }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('invoice/archive_invoices') }}">ارشيف الفواتير</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    @can('تقرير الفواتير')
                        <ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('report') }}">تقارير الفواتير</a>
                            </li>
                        @endcan
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ url('user') }}">قائمة المستخدمين</a></li>
                        @endcan
                        @can('صلاحيات المستخدمين')
                            <li><a class="slide-item" href="{{ url('role') }}">صلاحيات المستخدمين</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            <li class="side-item side-item-category"><a href="{{ url('cashier') }}"><i
                        class="fa-solid fa-cart-plus fa-xl"></i>الكاشير</a></li>

            </li>

            <li class="side-item side-item-category"><a href="{{ url('order') }}"> <i
                        class="fa-regular fa-clipboard fa-2xl"></i>الطلبات</a></li>
